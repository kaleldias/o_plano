...
fetch('http://127.0.0.1:3000/api/usuarios', {
    method: 'GET',
    headers: {
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjcyN2ZlZmVmLTViMzctNDUzZi1iMTVjLTI1YmMxYTkzMjhhYiIsImVtYWlsIjoia2FsQGdtYWlsLmNvbSIsInJvbGUiOiJzdXBlckFkbWluIiwiaWF0IjoxNzMzNzc5NjIzLCJleHAiOjE3MzM3ODMyMjN9.hP_fF2vPensGbP3vIgFBen-cjAf56hStbBfmDN7qNfI'
    }
})
